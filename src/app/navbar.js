  ...
  return (
    <div>
      <div className="relative">
        ...
        {!isNavVisible && (
          <button
            className="block p-0.5 border text-black mt-[30%] ml-3 hover:bg-gray-100 rounded lg :hidden"
            onClick={() => setIsNavVisible(true)}
          >
            <div className="w-7 h-7 p-1 flex items-center justify-center">
              <svg
        ...
        >
          ...
          <nav className="w-full  flex-col justify-between flex-grow md:hidden">
            <ul>
              <li className=" flex rounded items-center  ">
                <Link
                  href="/model"
                  className="flex  p-1 border text-2/3sm text-gray-700 hover:bg-gray-100 rounded mr-2 pl-2 pr-[30%] "
                >
              ...
              <li>
                <Link
                  href="/model"
                  className="flex items-center p-[1%] text-gray-600 hover:bg-gray-100 rounded text-sm"
                >
          ...
          <nav className="w-full md:block  flex-col justify-between flex-grow  hidden">
            <ul>
              <li className=" flex rounded items-center  ">
                <Link
                  href="/model"
