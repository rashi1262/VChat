...
<div className="flex flex-col gap-1 mr-36">
 ...
 (
  <div className="h-screen  bg-gray-50  flex-col items-center justify-center  md:hidden">
...
<div className="flex flex-col gap-1 mr-36">
 ...
 (
  <div className="h-screen md:block bg-gray-50   items-center justify-center ml-auto w-4/5 hidden">
