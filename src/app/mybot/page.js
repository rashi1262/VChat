    ...
    <>
      <div className="flex w-full justify-between bg-gray-50 text-sm">
        ...
        <div className="min-h-screen w-full bg-gray-50 flex flex-col items-center">
          <div className="max-w-6xl w-full px-4 py-6 mt-12">
            <div className="mb-8">
              <h1 className="text-2xl font-bold text-gray-800">My Bots</h1>
              <p className="text-gray-500 mt-2">Manage your favorite bots.</p>
            </div>

            {/* Favorite Bots Section */}
            <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
              ...
              <p className="text-gray-600 mb-6 text-sm">
                Your favorite bots will appear on the left. Drag and drop them
                to customize the order to suit your preferences.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {botCards.map((bot, index) => (
                  <Link
                    href={bot.href}
                    key={index}
                    className={`${bot.color} rounded-lg p-4 hover:shadow-md transition-all duration-200 flex flex-col items-center`}
                  >
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <p className="text-gray-600 mb-6 text-sm">
                Review your recently used bots below. You can easily change your
                favorite bots by drag and drop between the Recent and Favorite
                sections for a personalized experience.
              </p>

              <div className="flex justify-center">
                <Link
                  href="/explore"
                  className="flex items-center px-4 py-2 border border-gray-300 rounded-lg text-gray-600 hover:border-gray-400 hover:text-gray-800 transition-colors"
                >
                  Explore bots
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
