      ...
      <div className="h-screen w-64 bg-white text-black fixed left-0 top-0 flex flex-col items-center p-4">
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center mt-4 ml-auto w-4/5">
          <div className="max-w-4xl w-full rounded-md p-6 mt-10">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" className="CustomIcon-module__icon___zGR29 CustomIcon-module__icon--standart___0Ap1-"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.336" d="m14 12-.667.73a1.8 1.8 0 0 1-1.333.604c-.5 0-.98-.218-1.333-.604a1.8 1.8 0 0 0-1.334-.603c-.5 0-.979.217-1.333.603m-6 .604h1.116c.326 0 .49 0 .643-.037q.205-.05.385-.16c.135-.082.25-.198.48-.428L13 4.334a1.414 1.414 0 1 0-2-2l-8.375 8.375c-.23.23-.346.346-.429.48q-.11.181-.16.386C2 11.728 2 11.89 2 12.217z"></path></svg>
          </div>
          Customize
        </button>
            ...
            <div className="grid grid-cols-1 ">
              ...
              <h1 className="text-gray-300  mb-5  text-sm mr-36 ml-36">
                ...
                Your favorite bots will appear on the left. Drag and drop them to customize the order to suit your preferences.
                </h1>
              </div>
           ...
           <div className="w-10 h-10 m-3">
      <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42" className="CustomIcon-module__icon___zGR29 CustomIcon-module__icon--large___HBGvG"><path d="M.5 21C.5 9.678 9.678.5 21 .5S41.5 9.678 41.5 21 32.322 41.5 21 41.5.5 32.322.5 21Z" fill="#fff"></path><rect x="0.656" y="0.656" width="40.688" height="40.688" rx="20.344" stroke="#EEE" strokeWidth="1.313"></rect><g clipPath="url(#a)"><path d="M33 13.674v.53c-.197.576-.272 1.192-.581 1.73-.61 1.064-1.534 1.676-2.732 1.908-.291.057-.59.07-.584.518.018 1.56-.442 3.02-1.07 4.427-.466 1.04-1.167 1.929-1.949 2.76-.42.444-.396.47.164.676.414.153.825.318 1.225.503.244.112.584.18.515.569-.067.37-.36.501-.688.569a5.912 5.912 0 0 1-2.996-.15c-.332-.104-.522-.034-.752.14a8.46 8.46 0 0 1-1.295.818c-1.662.84-3.474.892-5.212.634-3.484-.519-5.893-2.569-7.344-5.745-.36-.79-.44-1.653-.702-2.466V19.08c.125-.084.087-.22.108-.336.359-1.94 1.297-3.53 2.939-4.661 1.578-1.086 3.37-1.225 5.206-1.004.43.052.797-.01 1.188-.142.938-.315 1.863-.71 2.893-.557.173.026.396.006.439.215.037.185-.192.223-.309.313-.649.503-.729 1.264-.097 1.686 1.191.797 2.149 1.84 3.166 2.822.485.469 1.004.893 1.636 1.159.146.061.286.159.44.02.345-.308.31-1.116-.061-1.41-1.492-1.18-1.987-3.152-1.23-4.854.108-.244.215-.452.536-.393.16.156.202.368.262.567.13.426.37.777.776.954.787.344 1.456.784 1.647 1.747.595-.56 1.228-.846 1.962-.837.681.007 1.252-.202 1.68-.734.298-.367.562-.35.818.036l.001.002ZM22.651 27.467c.094.36.205.644.537.143.044-.067.14-.1.21-.15.162-.158-.015-.216-.098-.275-1.334-.978-2.329-2.253-3.217-3.621-1.268-1.954-2.767-3.668-4.971-4.622-1.248-.54-2.538-.89-3.923-.71-.419.054-.635.238-.595.693.072.81.19 1.61.439 2.386.692 2.16 1.938 3.904 3.896 5.105.585.359 1.22.588 1.916.404.386-.103.572-.325.297-.745-.19-.292-.351-.613-.371-.98-.018-.32.116-.454.444-.415.292.036.54.17.784.312.612.359 1.209.741 1.754 1.194.847.7 1.749 1.267 2.9 1.282l-.002-.001Zm.089-6.797c-.192 1.174 1.195 1.769 1.91 1.325.267-.165.345-.32.214-.6-.371-.792-.864-1.498-1.54-2.058-.403-.334-.866-.566-1.418-.427-.207.052-.432.154-.442.4-.011.295.25.28.456.325.727.151.842.303.821 1.036l-.001-.001Zm-.58-.272c-.023-.18-.128-.301-.308-.292-.15.008-.266.12-.254.282.011.17.101.301.302.287.166-.011.243-.117.26-.276v-.001Z" fill="#506BFC"></path><path d="m22.652 27.469.746-.007c-.07.05-.165.084-.209.15-.332.501-.443.216-.537-.143Z" fill="#4C6EF2"></path></g><defs><clipPath id="a"><path fill="#fff" transform="translate(9 11.933)" d="M0 0h24v17.513H0z"></path></clipPath></defs></svg>                   </div>
           </div>
         </div>
         DeepSeek
                </Link>
         ...
         Upload & Ask PDF
           ...
           Recent
              ...
              Review your recently used bots below. You can easily change your favorite bots by drag and drop between the Recent and Favorite sections for a personalized experience.
                </h1>
         ...
         <li className="flex items-center mb-8 text-center justify-center space-x-2">
                ...
                >
                  ...
                  Explore bots
                  <div className="w-5 h-5">
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" ><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m6.75 13.5 4.5-4.5-4.5-4.5"></path></svg>
                </div>
